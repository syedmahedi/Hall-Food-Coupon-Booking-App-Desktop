...
public class shohidul extends javax.swing.JFrame {

    public shohidul() {
        initComponents();
    }

    public shohidul(String msg) {
        initComponents();
        jLabel4.setText(msg);
    }
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jSeparator6, javax.swing.GroupLayout.DEFAULT_SIZE, 482, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jTextField3.getText().equals("") || jTextField4.getText().equals("") || jTextField5.getText().equals("")) {
            ...
            try {
                FileReader reader = new FileReader("C:\\Users\\startech\\Desktop\\2nd Year 1st semester\\CSE 2100\\Shohidul Islam Hall\\Lunch_available_coupon.txt");
            ...
            if (x < 1) {
                ...
                try {
                    FileWriter writer = new FileWriter("C:\\Users\\startech\\Desktop\\2nd Year 1st semester\\CSE 2100\\Shohidul Islam Hall\\Lunch_coupon_details.txt", true);
                    ...
                    host = "localhost";
                    sub = "Your Lunch Coupon <Shohidul>";
                    ...
                    try {
                        ...
                        msg.setFrom(new InternetAddress(fromEmail, "Shohidul Islam Hall"));
            ...
            x--;
            try {
                FileWriter writer1 = new FileWriter("C:\\Users\\startech\\Desktop\\2nd Year 1st semester\\CSE 2100\\Shohidul Islam Hall\\Lunch_available_coupon.txt");
                writer1.write("" + x);
                writer1.flush();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (jTextField6.getText().equals("") || jTextField7.getText().equals("") || jTextField8.getText().equals("")) {
            ...
            try {
                FileReader reader = new FileReader("C:\\Users\\startech\\Desktop\\2nd Year 1st semester\\CSE 2100\\Shohidul Islam Hall\\Dinner_available_coupon.txt");
                BufferedReader bf = new BufferedReader(reader);
                String st = bf.readLine();
            ...
            if (y < 1) {
                ...
                try {
                    ...
                    FileWriter writer = new FileWriter("C:\\Users\\startech\\Desktop\\2nd Year 1st semester\\CSE 2100\\Shohidul Islam Hall\\Dinner_coupon_details.txt", true);
                    ...
                    host = "localhost";
                    sub = "Your Dinner Coupon <Shohidul>";
            ...
            y--;
            try {
                FileWriter writer1 = new FileWriter("C:\\Users\\startech\\Desktop\\2nd Year 1st semester\\CSE 2100\\Shohidul Islam Hall\\Dinner_available_coupon.txt");
                writer1.write("" + y);
                writer1.flush();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(shohidul.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
