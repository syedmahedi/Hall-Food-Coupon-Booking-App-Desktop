...
public class window1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel5.setBackground(new java.awt.Color(0, 118, 121));

        jLabel19.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel19.setForeground(new java.awt.Color(204, 204, 204));
        jLabel19.setText("Rajshahi University Of Engineering & Technology");

        jLabel20.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel20.setForeground(new java.awt.Color(255, 0, 0));
        jLabel20.setText("Hall Food Coupons Booking");
        ...
        jButton1.setBackground(new java.awt.Color(205, 205, 0));
        ...
        jLabel9.setForeground(new java.awt.Color(0, 115, 93));
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel8Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(jDateChooser5, javax.swing.GroupLayout.PREFERRED_SIZE, 195, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        jLabel10.setForeground(new java.awt.Color(0, 118, 93));
        ...
        jButton3.setBackground(new java.awt.Color(0, 154, 0));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jSeparator6, javax.swing.GroupLayout.DEFAULT_SIZE, 479, Short.MAX_VALUE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (jTextField6.getText().equals("") || jTextField7.getText().equals("") || jTextField8.getText().equals("")) {
            ...
            try {
                FileReader reader = new FileReader("C:\\Users\\startech\\Desktop\\2nd Year 1st semester\\CSE 2100\\Selim Hall\\Dinner_available_coupon.txt");
            ...
            if (y < 1) {
                ...
                Date date = jDateChooser6.getDate();
                String strDate = DateFormat.getDateInstance().format(date);
                try {

                    FileWriter writer = new FileWriter("C:\\Users\\startech\\Desktop\\2nd Year 1st semester\\CSE 2100\\Selim Hall\\Dinner_coupon_details.txt", true);
                    writer.write("\t" + y + "  " + email + " \t\t\t\t" + mobile + " \t\t\t" + Trxid + "\t\t\t" + strDate);
                    writer.write(System.getProperty("line.separator"));
                    writer.close();

                    host = "localhost";
                    sub = "Your Dinner Coupon <Selim>";
                    ...
                    try {
                        ...
                        msg.setFrom(new InternetAddress(fromEmail, "Selim Hall"));
            ...
            y--;
            try {
                FileWriter writer1 = new FileWriter("C:\\Users\\startech\\Desktop\\2nd Year 1st semester\\CSE 2100\\Selim Hall\\Dinner_available_coupon.txt");
                writer1.write("" + y);
                writer1.flush();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jTextField3.getText().equals("") || jTextField4.getText().equals("") || jTextField5.getText().equals("")) {
            ...
            try {
                FileReader reader = new FileReader("C:\\Users\\startech\\Desktop\\2nd Year 1st semester\\CSE 2100\\Selim Hall\\Lunch_available_coupon.txt");
                BufferedReader bf = new BufferedReader(reader);
                String st = bf.readLine();
            ...
            if (x < 1) {
                ...
                String strDate = DateFormat.getDateInstance().format(date);
                try {
                    FileWriter writer = new FileWriter("C:\\Users\\startech\\Desktop\\2nd Year 1st semester\\CSE 2100\\Selim Hall\\Lunch_coupon_details.txt", true);
                    writer.write("\t" + x + "  " + email + " \t\t\t\t" + mobile + " \t\t\t" + Trxid + "\t\t\t" + strDate);
                    writer.write(System.getProperty("line.separator"));
                    writer.close();

                    host = "localhost";
                    sub = "Your Lunch Coupon <Selim>";
            ...
            x--;
            try {
                FileWriter writer1 = new FileWriter("C:\\Users\\startech\\Desktop\\2nd Year 1st semester\\CSE 2100\\Selim Hall\\Lunch_available_coupon.txt");
                writer1.write("" + x);
                writer1.flush();
