...
public class Tinshed extends javax.swing.JFrame {

    public Tinshed() {
        initComponents();
    }

    public Tinshed(String msg) {
        initComponents();
        jLabel4.setText(msg);
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jTextField3.getText().equals("") || jTextField4.getText().equals("") || jTextField5.getText().equals("")) {
            ...
            try {
                FileReader reader = new FileReader("C:\\Users\\startech\\Desktop\\2nd Year 1st semester\\CSE 2100\\Tinshed Hall\\Lunch_available_coupon.txt");
            ...
            if (x < 1) {
                ...
                try {
                    FileWriter writer = new FileWriter("C:\\Users\\startech\\Desktop\\2nd Year 1st semester\\CSE 2100\\Tinshed Hall\\Lunch_coupon_details.txt", true);
                    ...
                    try {
                        ...
                        msg.setFrom(new InternetAddress(fromEmail, "Tin Shed Hall"));
            ...
            x--;
            try {
                FileWriter writer1 = new FileWriter("C:\\Users\\startech\\Desktop\\2nd Year 1st semester\\CSE 2100\\Tinshed Hall\\Lunch_available_coupon.txt");
                writer1.write("" + x);
                writer1.flush();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (jTextField6.getText().equals("") || jTextField7.getText().equals("") || jTextField8.getText().equals("")) {
            ...
            try {
                FileReader reader = new FileReader("C:\\Users\\startech\\Desktop\\2nd Year 1st semester\\CSE 2100\\Tinshed Hall\\Dinner_available_coupon.txt");
                BufferedReader bf = new BufferedReader(reader);
                String st = bf.readLine();
            ...
            if (y < 1) {
                ...
                try {
                    ...
                    FileWriter writer = new FileWriter("C:\\Users\\startech\\Desktop\\2nd Year 1st semester\\CSE 2100\\Tinshed Hall\\Dinner_coupon_details.txt", true);
                    writer.write("\t" + y + "  " + email + " \t\t\t\t" + mobile + " \t\t\t" + Trxid + "\t\t\t" + strDate);
                    writer.write(System.getProperty("line.separator"));
                    writer.close();
                    
                    host = "localhost";
                    sub = "Your Dinner Coupon <Tinshed>";
            ...
            y--;
            try {
                FileWriter writer1 = new FileWriter("C:\\Users\\startech\\Desktop\\2nd Year 1st semester\\CSE 2100\\Tinshed Hall\\Dinner_available_coupon.txt");
                writer1.write("" + y);
                writer1.flush();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tinshed.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
